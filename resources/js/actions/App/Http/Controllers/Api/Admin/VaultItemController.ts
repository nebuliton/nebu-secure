 ...
 * @see app/Http/Controllers/Api/Admin/VaultItemController.php:60
 ...
 * @see app/Http/Controllers/Api/Admin/VaultItemController.php:67
 * @route '/api/admin/vault-items/{vaultItem}'
 */
 ...
 * @see app/Http/Controllers/Api/Admin/VaultItemController.php:103
 * @route '/api/admin/vault-items/{vaultItem}'
 */
...
const VaultItemController = { index, store, show, update, destroy }
