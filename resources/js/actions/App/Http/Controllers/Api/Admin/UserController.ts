 ...
 */
export const issueTemporaryPassword = (
    args:
        | { user: number | { id: number } }
        | [user: number | { id: number }]
        | number
...
issueTemporaryPassword.url = (
    ...
    return (
        issueTemporaryPassword.definition.url
            .replace('{user}', parsedArgs.user.toString())
            .replace(/\/+$/, '') + queryParams(options)
    );
};
 ...
 * @route '/api/admin/users/{user}/issue-temporary-password'
 */
const issueTemporaryPasswordForm = (
    args:
        | { user: number | { id: number } }
        | [user: number | { id: number }]
        | number
 ...
 * @route '/api/admin/users/{user}/issue-temporary-password'
 */
issueTemporaryPasswordForm.post = (
    args:
        | { user: number | { id: number } }
        | [user: number | { id: number }]
        | number
