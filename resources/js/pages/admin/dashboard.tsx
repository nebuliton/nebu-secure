...
const sections = [
    ...
    },
    {
        title: 'Gruppen',
        description:
            'Gruppenmitgliedschaften und Berechtigungsbereiche verwalten.',
        href: '/admin/groups',
        icon: Layers3,
    },
    {
        ...
        description:
            'Verschlüsselte Team-Secrets sicher speichern und aktualisieren.',
                ...
                <Card className="overflow-hidden border-border/70 bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-slate-900 dark:to-slate-800">
                    ...
                    <CardContent>
                        <p className="max-w-3xl text-sm text-muted-foreground">
                            Admin-Oberfläche für verschlüsselte Secrets,
                            Identity-Lifecycle und revisionssichere Zuweisungen.
                        </p>
                    </CardContent>
                </Card>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    {sections.map((section) => (
                        <Link
                            key={section.title}
                            href={section.href}
                            className="rounded-xl border border-border/70 bg-card p-5 transition hover:-translate-y-0.5 hover:shadow-sm"
                        >
