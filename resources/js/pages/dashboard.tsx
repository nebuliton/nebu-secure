...
export default function Dashboard() {
    const { auth } = usePage<{ auth: { user: { role: 'admin' | 'user' } } }>()
        .props;
            ...
            <div className="space-y-6 p-6">
                <section className="overflow-hidden rounded-2xl border border-border/70 bg-gradient-to-br from-sky-50 to-indigo-100 p-8 dark:from-slate-950 dark:to-slate-900">
                    ...
                    <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
                        Team-Tresor mit serverseitiger Envelope Encryption,
                        strikter Autorisierung und nachvollziehbaren Zugriffen.
                    </p>
                </section>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    {isAdmin ? (
                        <>
                            ...
                            >
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Benutzer anlegen, Rollen setzen, Konten
                                    deaktivieren und Passwörter zurücksetzen.
                                </p>
                            </Link>
                            <Link
                            ...
                            >
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Verschlüsselte Secrets und Zuweisungen für
                        ...
                        >
                            ...
                            <p className="text-sm text-muted-foreground">
                                Deine direkten und gruppenbasierten Secrets
                                sicher anzeigen.
                            </p>
                        </Link>
                    )}
